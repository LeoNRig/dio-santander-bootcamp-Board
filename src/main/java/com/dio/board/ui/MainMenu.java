...
import com.dio.board.persistence.entity.BoardColumnKindEnum;
import com.dio.board.persistence.entity.BoardEntity;
import com.dio.board.persistence.entity.BoardMenu;
import com.dio.board.service.BoardQueryService;
import com.dio.board.service.BoardService;

import static com.dio.board.persistence.entity.BoardColumnKindEnum.CANCEL;
import static com.dio.board.persistence.entity.BoardColumnKindEnum.FINAL;
import static com.dio.board.persistence.entity.BoardColumnKindEnum.INITIAL;
import static com.dio.board.persistence.entity.BoardColumnKindEnum.PENDING;
    ...
    public void execute() throws SQLException {
        ...
        private void selectBoard() throws SQLException {
            ...
            try(var connection = getConnection()){
                ...
                optional.ifPresentOrElse(b -> new BoardMenu(optional.get()).execute(),() -> System.out.printf("Não foi encontrado o board com id %s\n", id));
            }
        }
